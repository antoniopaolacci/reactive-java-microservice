...
public class ToDoEndpoints extends Endpoints {
    ...
    @Api(path = "/api/v1/create", method = "POST", consumes = "application/json", produces = "application/json; charset=UTF-8")
    ...
    @Api(path = "/api/v1/read/{id}", method = "GET", produces = "application/json; charset=UTF-8")
    ...
    @Api(path = "/api/v1/read", method = "GET", produces = "application/json; charset=UTF-8")
    ...
    @Api(path = "/api/v1/update", method = "POST", consumes = "application/json", produces = "application/json; charset=UTF-8")
    ...
    @Api(path = "/api/v1/delete/{id}", method = "GET", produces = "application/json; charset=UTF-8")
